...
def api_client(catalog, users):
    ...
    with mock.patch('examples.fix_invalid_speakers.NudgisClient', return_value=client):
        yield client
...
def test_list_invalid_speakers(api_client, csv_path, ignore_errors):
    ...
    if ignore_errors:
        ...
        assert set(csv_lines[1:]) == {
            ...
            'https://nudgis/search/?text=user_3%40example.com'
