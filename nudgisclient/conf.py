# Nudgis client base configuration
# This file should not be modified directly, put your modification in json file and give the path to the client.

BASE_CONF = {
    # Logging level
    'LOG_LEVEL': 'INFO',

    # URL of the Nudgis site
    'SERVER_URL': 'https://nudgis',

    # API key of the Nudgis user account
    'API_KEY': '',
    ...
    # Use None to use Nudgis default language
